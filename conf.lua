...
-- A new global table
love.game = {path = love.filesystem.getSource() .. "/", width = 480, height = 270, frameRate = 60, version = "0.6 (alphaka)"}
...
function love.conf(t)
    ...
    t.window.width = love.game.width*love.scalefactor
    t.window.height = love.game.height*love.scalefactor
    t.window.vsync = true
