...
function level.load()
    ...
    local p3 = {x = love.game.width/3, y = 0}
    ...
    local p6 = {x = love.game.width/3, y = love.game.height}
	
	-- up - middle - middle
	local p7 = {x = love.game.width/2, y = love.game.height/3}
	local p8 = {x = love.game.width, y = love.game.height/2}
	
	-- down -- middle middle
	local p9 = {x = love.game.width/2, y = love.game.height-love.game.height/3}
	local p10 = {x = love.game.width, y = love.game.height-love.game.height/3}
	...
	-- Second wave
	table.insert(level.objects, {type = "ship", ship = mouse({p1, p7, p8}, p7, 2), time = 4})
	table.insert(level.objects, {type = "ship", ship = mouse({p4, p9, p10}, p9, 2), time = 0})
