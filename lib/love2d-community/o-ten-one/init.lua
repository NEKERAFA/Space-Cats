...
local timer = require "lib.love2d-community.o-ten-one.timer"
...
function splashlib.new(init)
  ...
  if init.fill == "rain" then
    ...
    rain.spacing_x = 110
    rain.spacing_y = 80
    rain.image = love.graphics.newImage("src/assets/images/splash/baby.png")
  ...
  self.alpha = 1
  self.heart = {
    sprite = love.graphics.newImage("src/assets/images/splash/heart.png"),
    scale = 0,
    rot   = 0
  }
  ...
  self.text = {
    obj   = love.graphics.newText(love.graphics.newFont("src/assets/fonts/splash/handy-andy.otf", 22), "made with"),
    alpha = 0
  }
  self.text.width, self.text.height = self.text.obj:getDimensions()

  self.logo = {
    sprite = love.graphics.newImage("src/assets/images/splash/logo.png"),
    mask   = love.graphics.newImage("src/assets/images/splash/logo-mask.png"),
    pen    = 0
  }
